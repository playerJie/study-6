...
public class Test4 {
    ...
    void test1() {
        ...
        Algorithm allAcoustic = new MyRouteAlgo2(dbr, dbr.getAlgoType(),
                "纯声", false,
                config.getAcousticDistance(), config.getAcousticDistance() + increment);
        Algorithm dss = new DssAlgo();
        Algorithm allOptical = new MyRouteAlgo2(dss, dss.getAlgoType(),
                "纯光", false,
                config.getOpticalDistance(), config.getOpticalDistance() + increment);
        Algorithm mix = new MyRouteAlgo();
        Algorithm mixed = new MyRouteAlgo2(mix, mix.getAlgoType(),
                "声光混合", false,
                config.getOpticalDistance(), config.getAcousticDistance() + increment);
